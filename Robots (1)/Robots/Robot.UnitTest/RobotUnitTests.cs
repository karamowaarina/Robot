...
namespace RobotsUnitTests
{
    ...
    public class RobotTests
    {
        ...
        {
            var robot = Robot.Create<ShooterAI, ShooterMover>(new ShooterAI(), new ShooterMover());
        ...
        {
            var robot = Robot.Create<ShooterAI, Mover>(new ShooterAI(), new Mover());
            var result = robot.Start(5).ToList();
        ...
        {
            var robot = Robot.Create<BuilderAI, Mover>(new BuilderAI(), new Mover());
            var result = robot.Start(5).ToList();
        ...
        {
            var robot = Robot.Create<GuardianAI, GuardianMover>(new GuardianAI(), new GuardianMover());
            var result = robot.Start(5).ToList();
